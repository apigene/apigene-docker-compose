...
apigene_load_env() {
  ...
  APIGENE_BACKEND_IMAGE_TAG="${APIGENE_DEFAULT_BACKEND_IMAGE_TAG}"
  APIGENE_COPILOT_IMAGE_TAG="${APIGENE_DEFAULT_COPILOT_IMAGE_TAG}"
  APIGENE_MCP_GW_IMAGE_TAG="${APIGENE_DEFAULT_MCP_GW_IMAGE_TAG}"
  APIGENE_NGINX_IMAGE_TAG="${APIGENE_DEFAULT_NGINX_IMAGE_TAG}"
  ...
  APIGENE_BACKEND_IMAGE_TAG="${APIGENE_BACKEND_IMAGE_TAG:-${APIGENE_DEFAULT_BACKEND_IMAGE_TAG}}"
  APIGENE_COPILOT_IMAGE_TAG="${APIGENE_COPILOT_IMAGE_TAG:-${APIGENE_DEFAULT_COPILOT_IMAGE_TAG}}"
  APIGENE_MCP_GW_IMAGE_TAG="${APIGENE_MCP_GW_IMAGE_TAG:-${APIGENE_DEFAULT_MCP_GW_IMAGE_TAG}}"
  APIGENE_NGINX_IMAGE_TAG="${APIGENE_NGINX_IMAGE_TAG:-${APIGENE_DEFAULT_NGINX_IMAGE_TAG}}"
}
